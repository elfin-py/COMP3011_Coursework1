...
let ChatService = ChatService_1 = class ChatService {
    ...
    constructor(recommendationService, jwtService, climateService) {
        this.recommendationService = recommendationService;
        this.jwtService = jwtService;
        this.climateService = climateService;
    }
    async recommendFromChat(dto, authHeader) {
    ...
    async tryExtractUserId(authHeader) {
    ...
    async generateAssistantReply(dto, prefs, tags, material, cleanMessage, cleanContext, weatherStyle) {
